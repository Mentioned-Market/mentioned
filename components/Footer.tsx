  ...
  return (
    <footer className="border-t border-white py-4 text-center mt-10">
      <div className="flex flex-col md:flex-row justify-center items-center gap-2 md:gap-6 font-mono text-xs uppercase">
        <a className="hover:bg-white hover:text-black transition-colors" href="https://discord.gg/gsD7vf6YRx" target="_blank" rel="noopener noreferrer">
          [DISCORD]
        </a>
        <a className="hover:bg-white hover:text-black transition-colors" href="https://x.com/mentionedmarket" target="_blank" rel="noopener noreferrer">
          [X]
        </a>

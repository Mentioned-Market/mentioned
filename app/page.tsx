...
const BG_COLUMNS: FakeMarket[][] = [
  [FAKE_MARKETS[0], FAKE_MARKETS[5], FAKE_MARKETS[10], FAKE_MARKETS[14]],
  [FAKE_MARKETS[1], FAKE_MARKETS[6], FAKE_MARKETS[11], FAKE_MARKETS[15], FAKE_MARKETS[18]],
  [FAKE_MARKETS[2], FAKE_MARKETS[7], FAKE_MARKETS[12], FAKE_MARKETS[16]],
  [FAKE_MARKETS[3], FAKE_MARKETS[8], FAKE_MARKETS[13], FAKE_MARKETS[17]],
  [FAKE_MARKETS[4], FAKE_MARKETS[9], FAKE_MARKETS[14], FAKE_MARKETS[0], FAKE_MARKETS[10]],
]
